...
/***/ function(module, exports, __webpack_require__) {
	...
	var LikeButton = __webpack_require__(160);

	ReactDOM.render(_react2.default.createElement(LikeButton, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _likeButton = __webpack_require__(161);
	...
	var HeartIcon = __webpack_require__(165);
	...
	var LikeButton = React.createClass({
	    ...
	    render: function render() {
	        var className = this.state.active ? _likeButton2.default.active : _likeButton2.default.normal;

	        return React.createElement(
	            'button',
	            { className: className, onClick: this.onClick, type: 'button' },
	            React.createElement(HeartIcon, { className: _likeButton2.default.icon }),
	            ' ',
	            React.createElement(
	                'span',
	                { className: _likeButton2.default.text },
	                'Like it!'
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/stylus-loader/index.js!./like-button.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/stylus-loader/index.js!./like-button.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".like-button__normal___240dX {\n  outline: none;\n  padding: 4px 10px 4px 8px;\n  cursor: pointer;\n  background-color: #fff;\n  border: #ccc solid 1px;\n  border-radius: 4px;\n}\n.like-button__icon___3Ghi7 {\n  fill: #bbb;\n  width: 18px;\n  height: 20px;\n  vertical-align: top;\n  transform: scale(0.85);\n  transition: all 0.2s;\n}\n.like-button__text___1T-ka {\n  font-weight: bold;\n  font-family: 'Helvetica Neue', Arial, sans-serif;\n  font-size: 14px;\n  line-height: 20px;\n  color: #777;\n}\n.like-button__normal___240dX:hover .like-button__icon___3Ghi7 {\n  fill: #f99696;\n}\n.like-button__normal___240dX:hover .like-button__text___1T-ka {\n  text-decoration: underline;\n}\n.like-button__active___OGkco {\n}\n.like-button__active___OGkco .like-button__icon___3Ghi7.like-button__icon___3Ghi7 {\n  fill: #ff4343;\n  transform: scale(1);\n}\n.like-button__active___OGkco .like-button__text___1T-ka {\n  color: #444;\n}\n", ""]);

	// exports
	exports.locals = {
		"normal": "like-button__normal___240dX",
		"icon": "like-button__icon___3Ghi7",
		"text": "like-button__text___1T-ka",
		"active": "like-button__active___OGkco like-button__normal___240dX"
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    render: function render() {
	        return React.createElement(
	            "svg",
	            _extends({}, this.props, { version: "1.1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 645 585" }),
	            React.createElement("path", { d: "M 297.29747,550.86823 C 283.52243,535.43191 249.1268,505.33855 220.86277,483.99412 C 137.11867,420.75228 125.72108,411.5999 91.719238,380.29088 C 29.03471,322.57071 2.413622,264.58086 2.5048478,185.95124 C 2.5493594,147.56739 5.1656152,132.77929 15.914734,110.15398 C 34.151433,71.768267 61.014996,43.244667 95.360052,25.799457 C 119.68545,13.443675 131.6827,7.9542046 172.30448,7.7296236 C 214.79777,7.4947896 223.74311,12.449347 248.73919,26.181459 C 279.1637,42.895777 310.47909,78.617167 316.95242,103.99205 L 320.95052,119.66445 L 330.81015,98.079942 C 386.52632,-23.892986 564.40851,-22.06811 626.31244,101.11153 C 645.95011,140.18758 648.10608,223.6247 630.69256,270.6244 C 607.97729,331.93377 565.31255,378.67493 466.68622,450.30098 C 402.0054,497.27462 328.80148,568.34684 323.70555,578.32901 C 317.79007,589.91654 323.42339,580.14491 297.29747,550.86823 z" })
	        );
	    }
	});
